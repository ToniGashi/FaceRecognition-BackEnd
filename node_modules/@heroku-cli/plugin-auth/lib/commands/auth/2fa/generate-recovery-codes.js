...
class Auth2faGenerate extends command_1.Command {
    async run() {
        cli_ux_1.default.warn('DEPRECATION WARNING: this command will be removed soon, in favor of generating recovery codes in your Account Settings in a browser.');
...
Auth2faGenerate.example = `$ heroku auth:2fa:generate
Password: ********************
Recovery codes:
02799c92ab3ba7c7
09aea052a72b6a22
